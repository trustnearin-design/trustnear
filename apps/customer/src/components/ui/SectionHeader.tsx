...
/**
 * Repeatable section header for home + browse screens:
 *
 *   [optional overline]
 *   Title in display font           See all  →
 *
 * Use `eyebrow` for tiny uppercase context labels ("WHAT YOU NEED"),
 * `title` for the bigger display heading ("Top verified pros near you").
 */
