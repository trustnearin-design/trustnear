...
/**
 * First-launch notification-readiness gate (Swiggy/UC style). Shows once,
 * walks the user through: (1) allow notifications, (2) allow background
 * (one-tap battery dialog), (3) auto-start settings shortcut. Keeps booking
 * pushes reliable even when the app is killed on aggressive OEM phones.
 *
 * Rendered from the (app) layout so it appears right after the user lands in
 * the app. Dismisses permanently once completed/skipped.
 */
export function NotificationGate() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      // Show until completed once. (If already granted AND seen, stay hidden.)
      ...
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' }}>
        ...
        >
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            >
              Expert on the way, OTP, service start & payment — sab alerts time pe paane ke liye 2
              cheezein on karein.
            </Text>
          </View>
          ...
          <Step
            ...
            body="Booking ke live updates ke liye."
          ...
          {/* Step 2 — background (Android only) */}
          {isAndroid ? (
            <Step
              n={2}
              done={bgTapped}
              title="Allow background activity"
              body="App band hone par bhi alerts aaye — battery dialog mein 'Allow' dabayein."
    ...
    <View style={{ marginTop: 16, flexDirection: 'row', alignItems: 'center' }}>
      ...
      <Pressable
        ...
        style={{
          ...
          paddingVertical: 8,
          borderRadius: 10,
          backgroundColor: disabled && done ? colors.success + '22' : colors.brand[50],
        }}
      >
        {loading ? (
