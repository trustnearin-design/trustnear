...
/**
 * D5 help & support screen — Plum hero with Sevak Searcher illustration,
 * FAQ accordion grouped by category, and a coral-accented support card.
 */
  ...
  return (
    <View className="flex-1" style={{ backgroundColor: colors.surface.muted }}>
        ...
        >
          <View style={{ flex: 1, paddingRight: 12 }}>
            ...
            <Text style={{ marginTop: 6, fontSize: 13, color: colors.brand[200] }}>
              Answers in seconds. Or talk to our team.
            </Text>
          </View>
      ...
      >
        ...
        {/* Support card — coral accent for "still stuck" call-to-action */}
        <View
          style={{
            marginHorizontal: 20,
            marginTop: 24,
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View style={{ marginLeft: 12, flex: 1 }}>
              ...
              <Text style={{ marginTop: 4, fontSize: 12, color: colors.brand[200] }}>
                support@trustnear.in · 9 AM – 9 PM, all days
              </Text>
            </View>
          </View>
        </View>
