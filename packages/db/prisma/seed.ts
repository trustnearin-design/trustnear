...
const children: ChildSeed[] = [
  ...
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 90,
    searchKeywords: ['carpenter', 'furniture', 'door', 'बढ़ई', 'kitchen'],
    sortOrder: 3,
  },
  {
    slug: 'painter',
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 240,
    searchKeywords: ['painter', 'paint', 'wall', 'पेंटर', 'putty'],
    sortOrder: 4,
  },
  {
    slug: 'mochi',
    ...
    searchKeywords: ['mochi', 'cobbler', 'shoe', 'मोची', 'polish'],
    sortOrder: 5,
  },
  // ─── Appliance Repair ──────────────────────────────────────
  {
  ...
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 90,
    searchKeywords: ['chimney', 'kitchen', 'चिमनी', 'hood'],
    sortOrder: 2,
  },
  {
    slug: 'ro-repair',
    ...
    searchKeywords: ['ro', 'water purifier', 'filter', 'पानी'],
    sortOrder: 3,
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 45,
    searchKeywords: ['gas', 'stove', 'चूल्हा', 'burner'],
    sortOrder: 4,
  },
  {
    slug: 'geyser-repair',
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 60,
    searchKeywords: ['geyser', 'water heater', 'गीजर'],
    sortOrder: 5,
  },
  {
  ...
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 60,
    searchKeywords: ['photography', 'baby shoot', 'family', 'फोटो'],
    sortOrder: 3,
  },
  {
    slug: 'tutor',
  ...
  // ─── Salon & Beauty — Mehndi addition ───────────────────────
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 120,
    searchKeywords: ['mehndi', 'henna', 'मेहंदी', 'bridal'],
    sortOrder: 5,
  },
  ...
  // ─── Home Care additions — sofa, water tank, sewage ─────────
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 90,
    searchKeywords: ['sofa', 'carpet', 'cleaning', 'foam', 'सोफा'],
    sortOrder: 5,
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 120,
    searchKeywords: ['water tank', 'tank cleaning', 'टंकी'],
    sortOrder: 6,
  },
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 120,
    searchKeywords: ['sewage', 'septic', 'drain', 'सीवेज'],
    sortOrder: 7,
  },
  ...
  // ─── Daily Help (hourly) ────────────────────────────────────
  {
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 60,
    searchKeywords: ['maid', 'cleaner', 'मेड', 'hourly', 'bai'],
    sortOrder: 1,
  },
  {
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 60,
    searchKeywords: ['bathroom', 'toilet', 'cleaner', 'बाथरूम'],
    sortOrder: 2,
  },
  {
    slug: 'cook-hourly',
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 60,
    searchKeywords: ['cook', 'maharaj', 'खाना', 'meals', 'rasoiya'],
    sortOrder: 3,
  },
  {
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 240,
    searchKeywords: ['office boy', 'peon', 'helper', 'चपरासी'],
    sortOrder: 4,
  },
  {
    ...
    searchKeywords: ['labour', 'mazdoor', 'मजदूर', 'construction'],
    sortOrder: 5,
  },
  ...
  // ─── Care Services ─────────────────────────────────────────
  {
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 240,
    searchKeywords: ['nurse', 'medical', 'नर्स', 'care'],
    sortOrder: 1,
  },
  {
    slug: 'elder-care',
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 480,
    searchKeywords: ['elder', 'senior', 'parents', 'बुजुर्ग', 'caretaker'],
    sortOrder: 2,
  },
  {
    slug: 'child-care',
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 240,
    searchKeywords: ['nanny', 'child', 'kid', 'बच्चे', 'babysitter'],
    sortOrder: 3,
  },
  ...
  // ─── Pet Care ──────────────────────────────────────────────
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 90,
    searchKeywords: ['dog', 'pet', 'grooming', 'कुत्ता'],
    sortOrder: 1,
  },
  {
    slug: 'dog-walking',
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 30,
    searchKeywords: ['dog walker', 'pet walking', 'walk'],
    sortOrder: 2,
  },
  ...
  // ─── Vehicle & Driver ──────────────────────────────────────
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 60,
    searchKeywords: ['car wash', 'detail', 'गाड़ी', 'cleaning'],
    sortOrder: 1,
  },
  {
    slug: 'bike-wash',
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 45,
    searchKeywords: ['bike wash', 'motorcycle', 'बाइक'],
    sortOrder: 2,
  },
  {
    slug: 'house-driver',
    ...
    priceUnit: 'per_hour',
    minDurationMinutes: 240,
    searchKeywords: ['driver', 'chauffeur', 'ड्राइवर'],
    sortOrder: 3,
  },
  ...
  // ─── Outdoor & Misc ────────────────────────────────────────
  {
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 120,
    searchKeywords: ['gardener', 'plants', 'lawn', 'माली'],
    sortOrder: 1,
  },
  {
    slug: 'laundry-pickup',
    ...
    priceUnit: 'per_visit',
    minDurationMinutes: 30,
    searchKeywords: ['laundry', 'wash', 'iron', 'कपड़े', 'dry clean'],
    sortOrder: 2,
  },
];
